...
import { Breadcrumb, BreadcrumbItem, Button, FormGroup, Form, Col, Input, Label, FormFeedback } from "reactstrap";
...
class Contact extends Component {
    ...
    handleBlur = (fields) => (evt) => {
        this.setState({
            touched: {...this.state.touched, [fields]: true}
        });
    }
    ...
    validate(firstname, lastname, telnum, email) {
        ...
        if(this.state.touched.lastname && lastname.length < 3)
            ...
            errors.firstname = 'Last name should be less than or equal to 10 characters';
